export class AppConstants {
    static BASE_STATIC_HOST = 'http://192.168.85.38:30180';
    // private static API_BASE_URL = "http://localhost:8079/";
    private static API_BASE_URL = '';
    private static OAUTH2_URL = AppConstants.API_BASE_URL + '/oauth2/authorization/';
    private static REDIRECT_URL = '/?redirect_uri=http://localhost:4200/user/login';
